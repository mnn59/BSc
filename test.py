...
parser.add_argument('--volume_path', type=str, default='/content/drive/MyDrive/MyTransunet/TransUNet-repo/data/Synapse/test_vol_h5', help='root dir for validation volume data')  # for acdc volume_path=root_dir
    ...
    for i_batch, sampled_batch in enumerate(tqdm(testloader)):
        ...
        with torch.no_grad():
            ...
            # print(prediction.shape)
                                          # Both Transunet and TransCASCADE
...
if __name__ == "__main__":
    ...
    if args.is_save:
        ...
        if dataset_name == 'Polyp':
            ...
            test_save_path = f'/content/drive/MyDrive/MyTransunet/results/cvckvasir'
    else:
        test_save_path = None
                    # test
